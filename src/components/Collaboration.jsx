    ...
    <Section crosses>
      ...
      >
            ...
            {collabContent.map((item) => (
              <li className="mb-3 py-3 " key={item.id}>
                <div className="flex items-center">
                  ...
                  <h6 className="body-2 m-5">{item.title}</h6>
                </div>
                {item.text && (
                  <p
                    className="
                        body-2 mt-3 text-n-4"
                  >
                    {item.text}
                  </p>
                )}
        ...
        <div className="lg:ml-auto xl:w-[38rem] mt-20">
          <p
            className="body-2 pb-6
                  text-n-4 md:mb-16
                  lg:mb-32 w-[22rem] lg:mx-auto
                  "
          >
            {collabText}
          </p>
              ...
              {collabApps.map((app, index) => (
                ...
                >
                  <div
                    ...
                    flex w-[3.2rem] h-[3.2rem] bg-n-7 border border-n-1/15 rounded-xl
                    -rotate-${index * 45}`}
                  >
                    <img
                      src={app.icon}
