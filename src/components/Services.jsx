    ...
    <Section id="how to use">
      <div className="container">
        <Heading
          ...
          text="Brainwave unlocks the potential of AI powred applications"
        />
        <div className="relative">
          <div
            className="relative z-1 flex items-center
                    h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden
                    lg:p-20 xl:h-[46rem]"
          >
            <div
          ...
          <div className="relative min-h-[39rem] border 
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end
                    p-8 bg-gradient-to-b from-n-8/0 ton-8/90 lg:p-15"
              >
            ...
            >
                    ...
                    <li
                      ...
                      ${
                        index === 2
                          ...
                          : "felx w-10 h-10 bg-n-6 md:w-15 md:h-15"
                      }`}
                    >
                      <div
                        className={`${
              ...
              <div className="relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]">
                <img
                  src={service3}
                  className="w-full h-full objtect-cover "
                  width={520}
                  height={400}
                  alt="Scary robot"
                />
